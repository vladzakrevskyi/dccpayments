...
//             }), t.isArray(o.activeIndex)) for (var i = o.activeIndex, s = 0; s < i.length; s++) c.openSection(n.eq(i[s] - 1), 0); else o.activeIndex > 1 ? c.openSection(n.eq(o.activeIndex - 1), 0) : !1 !== o.activeIndex && c.openSection(n.eq(0), 1)
